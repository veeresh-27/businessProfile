          ...
          <div className=" my-5   ">
            ...
            <div>
              ...
              <p className="text-md font-base text-gray-600">
                ...
                categorized based on the size of the companies like large,
                medium or small.
              </p>
              <h1 className="text-md text-green-600  my-4 font-bold">
                Debt Funds
              ...
              <p className="text-md font-base text-gray-600">
                ...
                designed to provide interest income for shareholders in the form
                of dividends that represent the total interest payments made by
              ...
              <p className="text-md font-base text-gray-600">
                ...
                stakeholders. These are income generating funds & tend to be
                less risky than other types of funds. It is a good choice of
                investment for those who seek regular payments over
                appreciation.
              </p>
              <h1 className="text-md text-green-600  my-4 font-bold">
                Balanced Funds
